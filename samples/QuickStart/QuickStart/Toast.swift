...
//  Toast.swift
//
//  Created by Yi Ke on 9/16/22.
//

import UIKit

class Toast {
    static func show(message: String, duration: Double, controller: UIViewController) {
    ...
    static func show(message: String, duration: Double, view: UIView) {
        let toastContainer = UIView(frame: CGRect())
        toastContainer.backgroundColor = UIColor.black.withAlphaComponent(0.6)
        toastContainer.alpha = 0.0
        toastContainer.layer.cornerRadius = 10;
        ...
        let c1 = NSLayoutConstraint(item: toastContainer, attribute: .leading, relatedBy: .equal, toItem: view, attribute: .leading, multiplier: 1, constant: 30)
        let c2 = NSLayoutConstraint(item: toastContainer, attribute: .trailing, relatedBy: .equal, toItem: view, attribute: .trailing, multiplier: 1, constant: -30)
