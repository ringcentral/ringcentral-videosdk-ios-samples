...
class RCVToolBarItem {
    ...
    func modelTuple() -> (iconName: Icon,
        ...
        case let .screenShare:
            return (iconName: .image(name: "iconsScreenshare"), title: "ScreenShare", accessibilityLabel: "Screen Share", accessibilityIdentifier: "ScreenShareButton", accessibilityValue: nil)
...
class RCVToolBarDataSource{
    ...
    var shareScreenViewModel: RCVToolBarItem = {
        let shareScreen = RCVToolBarItem(itemType: .screenShare)
        return shareScreen
    }()
